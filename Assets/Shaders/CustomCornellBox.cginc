...
{	
	...
	//light  //small, use with EXPLICIT_LIGHT_SAMPLING
	{float3(	0.0,    30.0, 		0.0),5.0,float3(1.0,1.0,1.0),float3(80.0,80.0,80.0), DIFFUSE, SPHERE},
	
	{float3(5.5, -5.7, 42.6),16.5,float3(1.0,1.0,1.0),float3(0.0,0.0,0.0), DIFFUSE, SPHERE}, //left mirror sphere
	...
	{float3(-19.0, -33.5, -15.0),16.5,float3(1.0,1.0,1.0),float3(0.0,0.0,0.0), DIFFUSE, SPHERE}	//center sphere
